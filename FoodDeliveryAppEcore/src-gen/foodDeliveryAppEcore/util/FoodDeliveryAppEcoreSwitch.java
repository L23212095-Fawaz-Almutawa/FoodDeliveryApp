 ...
 * @generated
 */
public class FoodDeliveryAppEcoreSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public FoodDeliveryAppEcoreSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case FoodDeliveryAppEcorePackage.USER: {
		...
		case FoodDeliveryAppEcorePackage.CUSTOMER_SERVICE: {
			CustomerService customerService = (CustomerService) theEObject;
			T result = caseCustomerService(customerService);
			if (result == null)
				result = caseUser(customerService);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case FoodDeliveryAppEcorePackage.DELIVERY_DRIVER: {
			...
			if (result == null)
				result = caseUser(deliveryDriver);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case FoodDeliveryAppEcorePackage.USER_BASE: {
			UserBase userBase = (UserBase) theEObject;
			T result = caseUserBase(userBase);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Customer Service</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Customer Service</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCustomerService(CustomerService object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>User Base</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>User Base</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUserBase(UserBase object) {
		return null;
	}
